...
for k in range(1,8):
    for i in range(2, 12):
        for j in range(1, 5):
            try:
                watch_name_element = driver.find_element(By.XPATH,
                                                         f'/html/body/div/div/div[3]/div[1]/div[2]/div[{i}]/div/div[{j}]/div/div/a[1]')
                watch_name = watch_name_element.text
            except:
                watch_name = ''

            try:
                watch_price_element = driver.find_element(By.XPATH,
                                                          f'/html/body/div/div/div[3]/div[1]/div[2]/div[{i}]/div/div[{j}]/div/div/a[2]/div/div[1]')
                watch_price = watch_price_element.text
            except:
                watch_price = ''
            ...
            try:
                description_element = driver.find_element(By.XPATH,
                                                          f'/html/body/div/div/div[3]/div[1]/div[2]/div[{i}]/div/div[{j}]/div/div/div[1]')
                description = description_element.text
            except:
                description = ''

            try:
                mrp_element = driver.find_element(By.XPATH,
                                                  f'/html/body/div/div/div[3]/div[1]/div[2]/div[{i}]/div/div[{j}]/div/div/a[2]/div/div[2]')
                mrp = mrp_element.text
            except:
                mrp = ''
            ...
            try:
                discount_element = driver.find_element(By.XPATH,
                                                       f'/html/body/div/div/div[3]/div[1]/div[2]/div[{i}]/div/div[{j}]/div/div/a[2]/div/div[3]/span')
                discount = discount_element.text
            except:
                discount = ''
    ...
    next_page_element=driver.find_element(By.XPATH,'/html/body/div/div/div[3]/div[1]/div[2]/div[12]/div/div/nav/a[12]/span')
